...
/*****************************************************************************************************************************
PV Characterization Project by the SENSORICA(C) Open Value Network  2015

Two axis brushless gimbal controller hardware for Photovoltaic cell characterization device. 
by Abran Khalid, Ahmed AKL, Thomas Vanesse, Jim Anastassiou, John CC (compulsive coder), Tiberius Brastaviceanu, Daniel Brastaviceanu, Bruce Merlot

Special Contributions:
  Tiberius Brastaviceanu
Project homepage: http://www.sensorica.co/home/what-we-do/projects/pv-characterization

Based on Brushless Gimbal Controller Software by Christian Winkler and Alois Hahn (C) 2013
http://sourceforge.net/projects/brushless-gimbal-brugi/

Modified source code written by Jim Anastassiou
...
Anyhow, if you start to commercialize our work, please read on http://www.sensorica.co on how to contribute

// I2Cdev library collection - MPU6050 I2C device class
// Based on InvenSense MPU-6050 register map document rev. 2.0, 5/19/2011 (RM-MPU-6000A-00)
// 10/3/2011 by Jeff Rowberg <jeff@rowberg.net>
// Updates should (hopefully) always be available at https://github.com/sensorica/PV_Project
*****************************************************************************************************************************/
...
/*****************************************************************          TODO - Re-evaluate new requirements and eliminate unecessary modules
